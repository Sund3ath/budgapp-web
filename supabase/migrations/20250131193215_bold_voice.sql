/*
  # Create loans and mileage_updates tables
  ...
  1. New Tables
    - `loans`
      ...
      - `name` (text)
      - `type` (text, either 'loan' or 'lease')
      - `principal` (numeric)
      ...
      - `mileage_limit` (integer, nullable)
  ...
  2. Security
    ...
    - Add policies for authenticated users to manage their own loans and mileage updates
*/
